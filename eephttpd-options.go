...
//Option is a SAMMud Option
type Option func(*SAMMud) error

//SetFilePath sets the path to save the config file at.
func SetFilePath(s string) func(*SAMMud) error {
	return func(c *SAMMud) error {
...
func SetType(s string) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if s == "http" {
...
func SetSigType(s string) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if s == "" {
...
func SetSaveFile(b bool) func(*SAMMud) error {
	return func(c *SAMMud) error {
...
func SetHost(s string) func(*SAMMud) error {
	return func(c *SAMMud) error {
...
func SetPort(s string) func(*SAMMud) error {
	return func(c *SAMMud) error {
...
//SetSAMHost sets the host of the SAMMud's SAM bridge
func SetSAMHost(s string) func(*SAMMud) error {
	return func(c *SAMMud) error {
...
//SetSAMPort sets the port of the SAMMud's SAM bridge using a string
func SetSAMPort(s string) func(*SAMMud) error {
	return func(c *SAMMud) error {
		port, err := strconv.Atoi(s)
		if err != nil {
...
//SetName sets the host of the SAMMud's SAM bridge
func SetName(s string) func(*SAMMud) error {
	return func(c *SAMMud) error {
...
func SetInLength(u int) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if u < 7 && u >= 0 {
...
func SetOutLength(u int) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if u < 7 && u >= 0 {
...
func SetInVariance(i int) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if i < 7 && i > -7 {
...
func SetOutVariance(i int) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if i < 7 && i > -7 {
...
func SetInQuantity(u int) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if u <= 16 && u > 0 {
...
func SetOutQuantity(u int) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if u <= 16 && u > 0 {
...
func SetInBackups(u int) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if u < 6 && u >= 0 {
...
func SetOutBackups(u int) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if u < 6 && u >= 0 {
...
func SetEncrypt(b bool) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if b {
...
//SetLeaseSetKey sets the host of the SAMMud's SAM bridge
func SetLeaseSetKey(s string) func(*SAMMud) error {
	return func(c *SAMMud) error {
...
//SetLeaseSetPrivateKey sets the host of the SAMMud's SAM bridge
func SetLeaseSetPrivateKey(s string) func(*SAMMud) error {
	return func(c *SAMMud) error {
...
//SetLeaseSetPrivateSigningKey sets the host of the SAMMud's SAM bridge
func SetLeaseSetPrivateSigningKey(s string) func(*SAMMud) error {
	return func(c *SAMMud) error {
...
//SetMessageReliability sets the host of the SAMMud's SAM bridge
func SetMessageReliability(s string) func(*SAMMud) error {
	return func(c *SAMMud) error {
...
func SetAllowZeroIn(b bool) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if b {
...
func SetAllowZeroOut(b bool) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if b {
...
func SetCompress(b bool) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if b {
...
func SetFastRecieve(b bool) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if b {
...
func SetReduceIdle(b bool) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if b {
...
func SetReduceIdleTime(u int) func(*SAMMud) error {
	return func(c *SAMMud) error {
...
func SetReduceIdleTimeMs(u int) func(*SAMMud) error {
	return func(c *SAMMud) error {
		c.SAMForwarder.Config().ReduceIdleTime = 300000
		if u >= 300000 {
...
func SetReduceIdleQuantity(u int) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if u < 5 {
...
func SetCloseIdle(b bool) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if b {
...
func SetCloseIdleTime(u int) func(*SAMMud) error {
	return func(c *SAMMud) error {
...
func SetCloseIdleTimeMs(u int) func(*SAMMud) error {
	return func(c *SAMMud) error {
		c.SAMForwarder.Config().CloseIdleTime = 300000
		if u >= 300000 {
...
func SetAccessListType(s string) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if s == "whitelist" {
...
func SetAccessList(s []string) func(*SAMMud) error {
	return func(c *SAMMud) error {
		if len(s) > 0 {
			for _, a := range s {
...
//SetTargetForPort sets the port of the SAMMud's SAM bridge using a string
/*func SetTargetForPort443(s string) func(*SAMMud) error {
	return func(c *SAMMud) error {
		port, err := strconv.Atoi(s)
		if err != nil {
...
//SetKeyFile sets
func SetKeyFile(s string) func(*SAMMud) error {
	return func(c *SAMMud) error {
